...
class CustomCard extends StatelessWidget {
  ...
  const CustomCard({Key key, this.cardTitle, this.caseTitle, this.currentData, this.newData, this.percentChange, this.icon, this.color, this.cardColor}) : super(key: key);
  @override
